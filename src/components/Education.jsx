    ...
    <div className="educationContainer" id='education'>
      ...
      <div className="educationDetails">
        <div className="imagesRow">
          <img src="/images/UBCLogo.jpg" alt="UBC Logo" width={100} height={75} />
          <img src="/images/EDXLogo.jpg" alt="EDX Logo" width={100} height={75} />
        </div>
        <div className='educationDetailsText'>
          <div className='educationDetailsHeaderText'>
            ...
            <button className='microMastersButton'>
              <a target="_blank" rel="noopener noreferrer" href='https://credentials.edx.org/credentials/2c72714f22124783a1999131e0f09176/'>View MicroMasters Credential</a>
            </button>
