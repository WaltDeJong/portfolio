  ...
  return (
    <div className="educationContainer" id='education'>
      <div className="educationText">
        ...
        <p>I love learning.  From my degree in psychology to addictions work and horticulture, each shift brought new insights and skills. Coding is my passion and I love creating things that are efficient, elegant and amazing </p>
        <p>This journey includes completing an extensive Software Development program consisting of six rigorous graduate-level courses offered by the University of British Columbia, which has been a cornerstone of my formal education in this field.</p>
        <p>I'm adaptable and continuously learning new technologies from documentation, project based learning, free online courses.  I believe there is always a solution, it just takes work.</p>
      </div>
